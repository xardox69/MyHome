...
class ArticleListModule {
    ...
    fun provideArticlePagerPresenter(getArticles: GetArticles, updateArticle: UpdateArticle,
                                     ...
                                     @Named(AppModule.ObserverScheduler) observerScheduler: Scheduler): ArticlePagerContract.Presenter = ArticlePagerPresenter(getArticles, updateArticle, subscriberScheduler, observerScheduler)
